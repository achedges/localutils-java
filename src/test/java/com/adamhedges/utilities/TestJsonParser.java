...
import com.adamhedges.utilities.json.*;
...
public class TestJsonParser {
	...
	public void testObjectParser() throws Exception {
		String testContents = new String(Files.readAllBytes(Paths.get("src/test/resources/parse-obj.json")));
	...
	public void testListParser() throws Exception {
		String testContents = new String(Files.readAllBytes(Paths.get("src/test/resources/parse-list.json")));
		JsonParser parser = new JsonParser(testContents);
		JsonElement result = parser.parse();
