...
import com.adamhedges.utilities.tabulator.ColumnDefinition;
import com.adamhedges.utilities.tabulator.Tabulator;
...
public class TestTabulator  {
	...
	public void testTableOutput() throws Exception {
		...
		String expected = new String(Files.readAllBytes(Paths.get("src/test/resources/table-results.txt")));
